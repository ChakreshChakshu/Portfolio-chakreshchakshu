...
export default function MagicRings({
  ...
  useEffect(() => {
    ...
    // Pre-allocated THREE.Color instances for smooth color transition interpolation
    ...
    const animate = (t) => {
      ...
      // Interpolate colors smoothly at 0.05 per frame (5% lerping factor)
      tempColor1.set(p.color);
      tempColor2.set(p.colorTwo);
      uniforms.uColor.value.lerp(tempColor1, 0.05);
      uniforms.uColorTwo.value.lerp(tempColor2, 0.05);
