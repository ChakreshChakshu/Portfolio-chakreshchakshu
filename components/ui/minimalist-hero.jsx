...
export function MinimalistHero({ className }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative grid w-full flex-grow grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-4 md:gap-12 z-10 max-w-7xl mx-auto my-auto items-center pt-24 md:pt-0">
