        ...
        >
          ...
          <div className="kinetic-line opacity-0 flex flex-col justify-center items-center text-center px-6 md:px-16 w-full h-[60vh] shrink-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl w-full px-4">
              {/* Card 1: Systems */}
              <div className="group relative p-6 rounded-2xl border border-white/5 bg-gradient-to-b from-white/[0.02] to-white/[0.01] backdrop-blur-xl flex flex-col items-center text-center transition-all duration-500 hover:-translate-y-2 hover:border-accent/30 hover:shadow-[0_15px_30px_-10px_rgba(255,49,46,0.15)]">
              ...
              {/* Card 3: Execution */}
              <div className="group relative p-6 rounded-2xl border border-white/5 bg-gradient-to-b from-white/[0.02] to-white/[0.01] backdrop-blur-xl flex flex-col items-center text-center transition-all duration-500 hover:-translate-y-2 hover:border-secondary/30 hover:shadow-[0_15px_30px_-10px_rgba(81,80,82,0.15)]">
                <div className="w-12 h-12 rounded-xl bg-secondary/10 border border-secondary/20 flex items-center justify-center text-secondary mb-5 group-hover:scale-110 transition-transform duration-300">
                  <Rocket size={24} weight="duotone" />
                </div>
                <h3 className="text-xl font-bold text-white tracking-wider mb-2 font-sans">
                  EXECUTION
                </h3>
                <div className="w-8 h-0.5 bg-secondary/30 mb-4" />
                <p className="text-sm text-white/60 leading-relaxed font-sans">
